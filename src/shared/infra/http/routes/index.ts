...
import { academicWorkTypesRoutes } from "../../../../modules/academicWorkTypes/http/routes/routes";
import { academicWorkRoutes } from "../../../../modules/academicWork/http/routes/routes";
...
routes.use("/academic-work-types", academicWorkTypesRoutes);
routes.use("/academic-works", academicWorkRoutes);
